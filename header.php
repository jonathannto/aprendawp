                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="account col-md-3">
                            <div class="account-menu"> banana </div>
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="brand col-md-3 col-lg-2 text-center text-md-left">
                            ...
                            <?php else: ?>
                                ...
                                <span><?php bloginfo('descritption'); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="site-menu col-md-9 col-lg-10">
                           <nav class="main-menu navbar navbar-expand-md navbar-light float-md-right" 
                            role="navigation">
                                <!-- Brand and toggle get grouped for better mobile display -->
                                <button class="navbar-toggler ml-auto" type="button" data-toggle="collapse"
                                    data-target="#bs-example-navbar-collapse-1" aria-controls="bs-example-navbar-collapse-1" 
                                    aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','aprendawp');?>">
